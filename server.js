...
app.get('/api/exchange-rate', async (req, res) => {
  try {
    ...
    const usdtToInr = response.data.tether.inr;
    const inrToUsdt = 1 / usdtToInr; // INR to USDT conversion
    res.json({ 
      success: true, 
      rate: inrToUsdt,
...
app.listen(PORT, () => {
  ...
  console.log('• New sections with smooth scrolling');
  console.log('• Updated color scheme (#014666)');
  console.log('• Currency display: INR → USDT');
});